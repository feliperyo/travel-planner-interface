    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <button type='button' onClick={openGuestsModal} className='flex items-center gap-2 flex-1'>
                ...
                <span className='text-zinc-400 teact-lg flex-1 text-left'>Quem estará na viagem?</span>
              </button>
        ...
        <p className="text-zinc-500 text-sm">Ao planejar sua viagem pelo Travel Planner você automaticamente concorda
          <br /> com nossos <a className="text-zinc-300 underline" href="#">termos de uso</a> e <a className="text-zinc-300 underline" href="#">políticas de privacidade</a>.</p>
      </div>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              <div className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2'>
                <span className='text-zinc-300'>ryofeliperyo@gmail.com</span>
                <button type='button'>
            ...
            <form className='p-2.5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2'>
              ...
              <div className='px-2 flex items-center flex-1 gap-2'>
                ...
                <input type="text" placeholder="Digite o e-mail do convidado" className="bg-transparent text-lg placeholder-zinc-400 w-40 outline-none flex-1" />
              </div>
